...
#[AsMessageHandler]
readonly class TransactionCanceledEventHandler
{
    ...
    public function __invoke(TransactionCanceledEvent $event): void
    {
        ...
        if (!$result->success) {
            $this->logger->error('Failed to handle transaction canceled event', [
